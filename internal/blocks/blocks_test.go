...
Block ID		0303030303030303030303030303030303030303030303030303030303030303
Parent ID		0404040404040404040404040404040404040404040404040404040404040404
...
Total Collections	3
    ...
    Collection 1:	0404040404040404040404040404040404040404040404040404040404040404
    Collection 2:	0606060606060606060606060606060606060606060606060606060606060606
`, "\n"), result.String())
	...
	assert.Equal(
		...
		map[string]any{
			...
			"height":           uint64(1),
			"parentId":         "0404040404040404040404040404040404040404040404040404040404040404",
			"totalCollections": 3,
			"totalSeals":       1,
		},
		result.JSON(),
