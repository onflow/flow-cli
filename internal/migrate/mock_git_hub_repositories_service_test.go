...
// mockGitHubRepositoriesService is an autogenerated mock type for the gitHubRepositoriesService type
...
func (_m *mockGitHubRepositoriesService) DownloadContents(ctx context.Context, owner string, repo string, filepath string, opt *github.RepositoryContentGetOptions) (io.ReadCloser, error) {
...
func (_m *mockGitHubRepositoriesService) GetContents(ctx context.Context, owner string, repo string, path string, opt *github.RepositoryContentGetOptions) (*github.RepositoryContent, []*github.RepositoryContent, *github.Response, error) {
...
// newMockGitHubRepositoriesService creates a new instance of mockGitHubRepositoriesService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockGitHubRepositoriesService(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockGitHubRepositoriesService {
