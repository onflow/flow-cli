...
require (
	...
	github.com/dapperlabs/cadence/languageserver v0.0.0-20200419232315-b690646ae182
	github.com/dapperlabs/flow-emulator v1.0.0-alpha.5.0.20200419233041-e908445327a6
