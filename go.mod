...
require (
	...
	github.com/onflow/cadence-tools/languageserver v1.0.0-preview.9
	...
	github.com/onflow/flixkit-go v1.2.1-cadence-v1-preview.8
	...
	github.com/onflow/flow-evm-gateway v0.3.2-0.20240328191050-38db68c9abfc
