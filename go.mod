...
require (
	...
	github.com/onflow/cadence-tools/languageserver v1.0.0-preview.8
	...
	github.com/onflow/flixkit-go v1.2.1-cadence-v1-preview.7
	...
	github.com/onflow/flow-evm-gateway v0.3.2-0.20240321190042-b97076e80c66
