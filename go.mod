...
require (
	...
	github.com/onflow/cadence/languageserver v0.25.1-0.20220818081851-fa27bdedf49f
	github.com/onflow/fcl-dev-wallet v0.4.9
	github.com/onflow/flow-cli/pkg/flowkit v0.0.0-20220817103314-255dfff1c022
