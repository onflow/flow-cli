...
require (
	...
	github.com/onflow/cadence-tools/languageserver v1.0.0-preview.34
	github.com/onflow/cadence-tools/lint v1.0.0-preview.34
	github.com/onflow/cadence-tools/test v1.0.0-preview.34
