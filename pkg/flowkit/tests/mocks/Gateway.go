...
import (
	...
	util "github.com/onflow/flow-cli/pkg/flowkit/util"
)
...
func (_m *Gateway) ExecuteScript(_a0 []byte, _a1 []cadence.Value, _a2 *util.ScriptQuery) (cadence.Value, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 cadence.Value
	if rf, ok := ret.Get(0).(func([]byte, []cadence.Value, *util.ScriptQuery) cadence.Value); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]byte, []cadence.Value, *util.ScriptQuery) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
